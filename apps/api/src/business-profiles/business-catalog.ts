...
export const businessCategories: BusinessCategoryDefinition[] = [
  { key: "commerce", name: "Commerce", description: "Boutiques, markets, supermarches et grossistes.", activities: [
    { name: "Boutique / Market", profileType: "commerce" }, { name: "Supermarche", profileType: "commerce" }, { name: "Dépôt de boissons", profileType: "commerce" }, { name: "Grossiste", profileType: "commerce" }, { name: "Librairie", profileType: "commerce" }, { name: "Électronique", profileType: "commerce" }, { name: "Téléphones & Accessoires", profileType: "commerce" }
  ] },
