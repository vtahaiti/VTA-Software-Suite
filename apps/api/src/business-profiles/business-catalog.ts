...
export const businessProfiles: BusinessProfileDefinition[] = [
  { slug: "commerce", name: "Commerce", description: "Mod̬le simple pour boutiques, markets et grossistes.", category: "Commerce", icon: "store", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings"] },
  { slug: "fashion", name: "Mode & Beaut̩", description: "Commerce avec tailles, couleurs et collections.", category: "Mode & Beaut̩", icon: "shirt", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings", "fashion"] },
  { slug: "restaurant", name: "Restaurant", description: "POS, menu, ventes en attente, historique et tickets.", category: "Restaurant & Alimentation", icon: "utensils", modules: ["dashboard", "pos", "products", "customers", "sales", "reports", "settings", "restaurant"] },
  { slug: "hotel", name: "H̫tel", description: "H̩bergement, clients, facturation et services.", category: "H̫tel & H̩bergement", icon: "hotel", modules: ["dashboard", "pos", "customers", "sales", "reports", "settings", "hotel"] },
  { slug: "hotel-restaurant", name: "Hotel avec restaurant", description: "Hebergement avec POS restaurant, produits/menu, stock simple et facturation.", category: "Hotel / Hebergement", icon: "hotel", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings", "hotel", "restaurant"] },
  { slug: "pharmacy", name: "Pharmacie", description: "Commerce avec lots et expirations.", category: "Sant̩", icon: "pill", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings", "pharmacy"] },
  { slug: "clinic", name: "Clinique", description: "Patients, services et facturation.", category: "Sant̩", icon: "clinic", modules: ["dashboard", "pos", "customers", "sales", "reports", "settings", "pharmacy"] },
