...
export const businessActivityTemplates: BusinessActivityTemplate[] = [
  ...
  { label: "Multi-activités", categoryKey: "multi-activities", profileType: "multi-activities", categories: ["Commerce", "Services", "Production", "Stock", "Commandes"] },
...
export const businessCategories: BusinessCategoryDefinition[] = [
  ...
  { key: "construction", name: "Construction", description: "Quincaillerie, matériaux, électricité et ateliers.", activities: [
    { name: "Quincaillerie", profileType: "hardware" }, { name: "Matériaux de construction", profileType: "construction-materials" }, { name: "Électricité", profileType: "commerce" }, { name: "Plomberie", profileType: "commerce" }, { name: "Aluminium / Vitrerie", profileType: "windows-aluminium" }, { name: "Menuiserie", profileType: "manufacturing" }, { name: "Ferronnerie", profileType: "manufacturing" }
  ] },
  ...
  { key: "multi-activities", name: "Multi-activités", description: "Entreprises avec plusieurs activités.", activities: [
    { name: "Entreprise multi-services", profileType: "multi-activities" }, { name: "Groupe d'entreprises", profileType: "multi-activities" }, { name: "Holding", profileType: "multi-activities" }, { name: "Autre multi-activités", profileType: "multi-activities" }
  ] },
...
export const businessProfiles: BusinessProfileDefinition[] = [
  ...
  { slug: "multi-activities", name: "Multi-activités", description: "Plusieurs activités dans une même entreprise.", category: "Multi-activités", icon: "layers", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings", "printing", "garage", "it-services", "measurements", "restaurant"] }
];
