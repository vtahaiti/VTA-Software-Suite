...
export const businessModules: BusinessModuleDefinition[] = [
  ...
  { key: "restaurant", name: "Restaurant", description: "Restaurant V1 avec POS, menu, commandes ouvertes, stock simple et tickets", category: "Sp̩cialis̩", icon: "utensils", permissions: ["pos.sell"], menuItems: [{ label: "POS / Nouvelle commande", href: "/dashboard/pos", section: "Restaurant" }, { label: "Produits / menus", href: "/dashboard/products", section: "Restaurant" }, { label: "Commandes ouvertes", href: "/dashboard/sales/in-progress", section: "Restaurant" }, { label: "Historique ventes", href: "/dashboard/sales/completed", section: "Restaurant" }, { label: "Stock ingredients / Inventaire", href: "/dashboard/inventory", section: "Restaurant" }, { label: "Depenses / achats", href: "/dashboard/purchases", section: "Restaurant" }, { label: "Notifications", href: "/dashboard/notifications", section: "Restaurant" }], widgets: [{ key: "restaurant-pos", label: "POS restaurant", description: "Prise de commande et ticket" }, { key: "restaurant-menu", label: "Produits / menus", description: "Plats, boissons et menus" }] },
