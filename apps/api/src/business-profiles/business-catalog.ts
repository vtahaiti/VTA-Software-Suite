...
export const businessSectors: BusinessSectorDefinition[] = [
  ...
  { key: "transport-distribution", name: "Transport / Location", description: "Transport, location vehicules, livraison et logistique.", specialties: [
    ...
    { name: "Location vehicules", profileType: "vehicle-rental", categories: ["Vehicules", "Location", "Services"] },
...
export const businessModules: BusinessModuleDefinition[] = [
  ...
  { key: "pharmacy", name: "Pharmacie", description: "Suivi des dates d'expiration par produit", category: "Spécialisé", icon: "pill", permissions: ["products.view", "inventory.view"], menuItems: [{ label: "Lots et expirations", href: "/dashboard/pharmacy/expirations", section: "Stock" }], widgets: [{ key: "expiring-products", label: "Produits bientôt expirés", description: "Surveillance pharmacie" }] },
  ...
  { key: "manufacturing", name: "Fabrication", description: "Production : conversion des matières premières en produits finis avec débit/crédit de stock atomique", category: "Spécialisé", icon: "factory", permissions: ["inventory.adjust"], menuItems: [{ label: "Production", href: "/dashboard/manufacturing/production", section: "Fabrication" }], widgets: [{ key: "production", label: "Production", description: "Suivi des lots de production" }] },
  { key: "restaurant", name: "Restaurant", description: "Restaurant V1 avec POS, menu, commandes ouvertes, stock simple et tickets", category: "Spécialisé", icon: "utensils", permissions: ["pos.sell"], menuItems: [{ label: "POS / Nouvelle commande", href: "/dashboard/pos", section: "Restaurant" }, { label: "Produits / menus", href: "/dashboard/products", section: "Restaurant" }, { label: "Commandes ouvertes", href: "/dashboard/sales/in-progress", section: "Restaurant" }, { label: "Historique ventes", href: "/dashboard/sales/completed", section: "Restaurant" }, { label: "Stock ingrédients / Inventaire", href: "/dashboard/inventory", section: "Restaurant" }, { label: "Notifications", href: "/dashboard/notifications", section: "Restaurant" }], widgets: [{ key: "restaurant-pos", label: "POS restaurant", description: "Prise de commande et ticket" }, { key: "restaurant-menu", label: "Produits / menus", description: "Plats, boissons et menus" }] },
  { key: "clinic", name: "Clinique", description: "Fiche patient avec note médicale et historique des consultations", category: "Spécialisé", icon: "clinic", permissions: ["customer.read"], menuItems: [{ label: "Patients", href: "/dashboard/clinic/patients", section: "Clinique" }], widgets: [{ key: "patients", label: "Patients", description: "Suivi patients" }] },
  { key: "hotel", name: "Hôtel", description: "Réservations de chambres avec dates d'arrivée/départ et disponibilité en temps réel", category: "Spécialisé", icon: "hotel", permissions: ["sales.read"], menuItems: [{ label: "Réservations & Chambres", href: "/dashboard/hotel/rooms", section: "Hôtel" }], widgets: [{ key: "rooms", label: "Chambres", description: "Occupation en temps réel" }] },
  { key: "vehicle-rental", name: "Location de véhicules", description: "Location de véhicules avec dates de départ/retour et disponibilité en temps réel", category: "Spécialisé", icon: "car", permissions: ["sales.read"], menuItems: [{ label: "Location de véhicules", href: "/dashboard/rental/vehicles", section: "Location" }], widgets: [{ key: "vehicles", label: "Véhicules", description: "Disponibilité en temps réel" }] },
...
export const businessProfiles: BusinessProfileDefinition[] = [
  ...
  { slug: "windows-aluminium", name: "Fabrication fenêtres/portes", description: "Fenêtres, portes, cadres, vitrines, moustiquaires, devis avec mesures, acomptes et installation simple.", category: "Construction", icon: "window", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings", "measurements", "manufacturing"] },
  ...
  { slug: "vehicle-rental", name: "Location de véhicules", description: "Flotte de véhicules, réservations avec dates de départ/retour et disponibilité.", category: "Automobile", icon: "car", modules: ["dashboard", "products", "customers", "reports", "settings", "vehicle-rental"] },
  { slug: "manufacturing", name: "Fabrication", description: "Ateliers et production artisanale.", category: "Fabrication", icon: "factory", modules: ["dashboard", "pos", "products", "inventory", "customers", "suppliers", "sales", "reports", "settings", "measurements", "manufacturing"] },
