...
export const businessCategories: BusinessCategoryDefinition[] = [
  ...
  { key: "restaurant-food", name: "Restaurant & Alimentation", description: "Restaurant, bar, boulangerie et alimentation preparee.", activities: [
  ...
  { key: "services", name: "Services", description: "Services professionnels et informatiques.", activities: [
    { name: "Cabinet comptable", profileType: "services" }, { name: "Cabinet d'avocats", profileType: "services" }, { name: "Agence immobiliere", profileType: "services" }, { name: "Agence de voyage", profileType: "services" }, { name: "Entreprise securite", profileType: "services" }, { name: "Cybercafe", profileType: "it-services" }, { name: "Services informatiques", profileType: "it-services" }
  ] },
...
export const businessModules: BusinessModuleDefinition[] = [
  ...
  { key: "pos", name: "Nouvelle vente", description: "Vente rapide, caisse et tickets", category: "Vente", route: "/dashboard/pos", icon: "pos", permissions: ["pos.sell"], menuItems: [{ label: "Nouvelle vente", href: "/dashboard/pos", section: "Principal" }, { label: "Historique POS", href: "/dashboard/pos/history", section: "Ventes" }, { label: "Sessions caisse", href: "/dashboard/pos/sessions", section: "Parametres" }, { label: "Caisses", href: "/dashboard/cash-registers", section: "Parametres" }], widgets: [{ key: "sales-today", label: "Ventes du jour", description: "Ventes POS aujourd'hui" }] },
  { key: "products", name: "Produits", description: "Catalogue produits et variantes", category: "Catalogue", route: "/dashboard/products", icon: "box", permissions: ["products.view"], menuItems: [{ label: "Produits", href: "/dashboard/products", section: "Produits" }, { label: "Categories", href: "/dashboard/products/categories", section: "Produits" }, { label: "Marques", href: "/dashboard/products/brands", section: "Produits" }, { label: "Unites", href: "/dashboard/products/units", section: "Produits" }], widgets: [{ key: "products", label: "Produits", description: "Produits actifs" }] },
  { key: "inventory", name: "Stock", description: "Stock, mouvements, alertes et transferts", category: "Stock", route: "/dashboard/inventory", icon: "warehouse", permissions: ["inventory.view"], menuItems: [{ label: "Stock", href: "/dashboard/inventory", section: "Stock" }, { label: "Mouvements", href: "/dashboard/inventory/movements", section: "Stock" }, { label: "Ajustements", href: "/dashboard/inventory/adjustments", section: "Stock" }, { label: "Transferts", href: "/dashboard/transfers", section: "Stock" }, { label: "Magasins", href: "/dashboard/stores", section: "Stock" }, { label: "Entrepots", href: "/dashboard/warehouses", section: "Stock" }], widgets: [{ key: "low-stock", label: "Stock faible", description: "Produits sous seuil" }, { key: "stock-by-store", label: "Stock par magasin", description: "Stock repartit par point de vente" }] },
  ...
  { key: "reports", name: "Rapports", description: "Rapports business et exports", category: "Administration", route: "/dashboard/reports", icon: "chart", permissions: ["reports.read"], menuItems: [{ label: "Rapports", href: "/dashboard/reports", section: "Principal" }, { label: "Import / Export", href: "/dashboard/import-export", section: "Parametres" }], widgets: [{ key: "revenue", label: "Chiffre d'affaires", description: "Performance commerciale" }] },
  { key: "settings", name: "Parametres", description: "Configuration entreprise et securite", category: "Administration", route: "/dashboard/settings/company", icon: "settings", permissions: ["settings.read"], menuItems: [{ label: "Parametres", href: "/dashboard/settings/company", section: "Principal" }, { label: "Entreprise", href: "/dashboard/settings/company", section: "Parametres" }, { label: "Profil", href: "/profile", section: "Parametres" }, { label: "Utilisateurs", href: "/dashboard/settings/roles", section: "Parametres" }, { label: "Roles", href: "/dashboard/settings/roles", section: "Parametres" }, { label: "Permissions", href: "/dashboard/settings/permissions", section: "Parametres" }, { label: "Parametres POS", href: "/dashboard/settings/pos", section: "Parametres" }, { label: "Facturation", href: "/dashboard/settings/invoicing", section: "Parametres" }, { label: "Securite", href: "/dashboard/security", section: "Parametres" }, { label: "Sauvegardes", href: "/dashboard/backups", section: "Parametres" }, { label: "Audit", href: "/dashboard/audit", section: "Parametres" }, { label: "Business Modules", href: "/dashboard/settings/business-modules", section: "Parametres" }], widgets: [] },
  ...
  { key: "pharmacy", name: "Pharmacie", description: "Lots, expiration et ordonnances preparees", category: "Specialise", icon: "pill", permissions: ["products.view", "inventory.view"], menuItems: [{ label: "Lots et expirations", href: "/dashboard/inventory", section: "Stock" }], widgets: [{ key: "expiring-products", label: "Produits bientot expires", description: "Surveillance pharmacie" }] },
