...
export class CompanyProfileService {
  ...
  async find(tenantId: string) {
    ...
    return {
      ...
      businessLicenseNumber: tenant.companyProfile?.businessLicenseNumber ?? "",
      bankName: tenant.companyProfile?.bankName ?? "",
      bankAccountNumber: tenant.companyProfile?.bankAccountNumber ?? "",
  ...
  async update(tenantId: string, dto: UpdateCompanyProfileDto) {
    await this.prisma.$transaction(async (tx) => {
      ...
      const normalized = {
        ...
        businessLicenseNumber: keep(dto.businessLicenseNumber, current.companyProfile?.businessLicenseNumber ?? null),
        bankName: keep(dto.bankName, current.companyProfile?.bankName ?? null),
        bankAccountNumber: keep(dto.bankAccountNumber, current.companyProfile?.bankAccountNumber ?? null),
      ...
      await tx.companyProfile.upsert({
        ...
        create: {
          ...
          businessLicenseNumber: normalized.businessLicenseNumber,
