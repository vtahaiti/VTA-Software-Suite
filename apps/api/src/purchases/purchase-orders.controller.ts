...
export class PurchaseOrdersController {
  ...
  @Post("invoices") @Permissions("purchases.create") createInvoice(@Req() request: AuthenticatedRequest, @Body() dto: any) { return this.purchaseOrdersService.createSupplierInvoice(request.user.tenantId, dto); }
  @Post("payments") @Permissions("purchases.create") createPayment(@Req() request: AuthenticatedRequest, @Body() dto: any) { return this.purchaseOrdersService.createSupplierPayment(request.user.tenantId, request.user.id, dto); }
  ...
  @Get("export/excel") @Header("Content-Type", "application/vnd.ms-excel") @Header("Content-Disposition", "attachment; filename=purchases.xls") @Permissions("purchases.export") exportExcel(@Req() request: AuthenticatedRequest) { return this.purchaseOrdersService.exportExcel(request.user.tenantId); }
