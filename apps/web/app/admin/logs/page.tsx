...
export default function AdminLogsPage() {
  ...
  return (
    <AdminShell>
      <div className="mb-5"><h2 className="text-2xl font-black text-white">Sécurité & Logs plateforme</h2><p className="mt-1 text-sm text-slate-400">Connexions, erreurs critiques, notes internes et événements plateforme.</p></div>
