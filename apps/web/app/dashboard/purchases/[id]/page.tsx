...
const statusLabels: Record<string, string> = { DRAFT: "Brouillon", APPROVED: "Valide", PARTIALLY_RECEIVED: "Recu partiel", FULLY_RECEIVED: "Recu complet", CANCELLED: "Annule" };
