      ...
      <div className="grid gap-3 md:hidden">
        {items.map((product) => <article key={product.id} className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="rounded-md bg-slate-50 p-2 dark:bg-slate-950"><span className="text-slate-500">Catégorie</span><p className="truncate font-semibold">{product.category?.name ?? "--"}</p></div>
          </div>
