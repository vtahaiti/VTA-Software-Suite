...
const citiesByCountry: Record<string, string[]> = {
  Haiti: ["Cap-Haitien", "Trou-du-Nord", "Ouanaminthe", "Fort-Liberte", "Limonade", "Quartier-Morin", "Milot", "Caracol", "Hinche", "Port-au-Prince"],
...
export default function OnboardingCompanyPage() {
  ...
  useEffect(() => {
    setPendingToken(window.localStorage.getItem("vta_pending_onboarding") ?? "");
